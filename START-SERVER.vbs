...
cmd = javaExe & " --module-path ""target\classes;" & jfxPath & """ --add-modules javafx.controls,javafx.fxml,javafx.graphics,com.peerchat -m com.peerchat/com.peerchat.server.ServerApp"
